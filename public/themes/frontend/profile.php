        ...
        <div data-depth="0.65" class="sk__absolute">
            <div class="sk__flex-center sk__absolute px-15px">
                <div class="flex-child">
                    <h1 class="shadowed super-heading text-center"><?= $loggedUser['username']; ?></h1>
                    <h2 class="shadowed h2-small text-center">profile page</h2>
                </div>
            </div>
        </div>
        <!-- heading & subheading -->
        <div data-depth="0.65" class="sk__absolute">
            <div class="sk__flex-center sk__absolute px-15px">
                <div class="flex-child text-center">
                    <h1 class="super-heading sk__clipped-text sk__gradient-back-v1"><?= $loggedUser['username']; ?></h1>
                    <h2 class="h2-small">profile page</h2>
                </div>
            </div>
        </div>
