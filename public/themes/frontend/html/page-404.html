						...
						<div class="carousel-inner">
							...
							<div class="carousel-item zooming active hero-slide-1 sk__hero-slider-item sk__image-back-cover">
								<section class="sk__parallax-background-section sk__hero-item-center-center">
									<div class="sk__parallax-background-element sk__absolute sk__image-back-cover" style="background-image: url(assets/images/404-page.webp);"></div>
										...
										<div class="row">
											<div class="col-xl-10 offset-xl-1">
												...
												<div class="cover-text-wrapper">
													<h2><span class="sk__404 animated-element phase-1">404</span></h2>
												</div>
												<div class="cover-text-wrapper">
													<h2 class="h2-super thin animated-element phase-1">You have wandered <span class="d-inline-block">way too far</span></h2>
												</div>
												<div class="cover-text-wrapper">
